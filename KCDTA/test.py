...
from utils import *
from plot_utils import save_scatter_plot
...
for dataset in datasets:
   ...
   model.load_state_dict(torch.load('model_cnn_'+dataset+'.model', weights_only=True))
   model.to(device)
   ...
   print(f"Results for {dataset}: {ret1}")

   # 3. Generate Scatter Plot
   save_scatter_plot(G, P, dataset)
